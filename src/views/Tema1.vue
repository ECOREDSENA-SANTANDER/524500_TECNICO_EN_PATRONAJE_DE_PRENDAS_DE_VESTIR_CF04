        ...
        .row(titulo="1")
          .col-md-5.mb-4.mb-md-0
            ...
            ul.lista-ul--color.fa-ul.color-primario.ps-5
              li 
                i.fas.fa-plus
                | #[b Ancho: ] ¼ de contorno de cadera.
              li
                i.fas.fa-plus
                | #[b Largo: ] largo según talla (talla 10 = 60 cm).
          .col-md-7
        ...
        .row(titulo="2")
          .col-md-5.mb-4.mb-md-0
            ...
            ul.lista-ul--color.fa-ul.color-primario.ps-5
              li 
                i.fas.fa-plus
                | #[b Altura de cadera: ] según talla (talla 10 = 18 cm).
          .col-md-7
        ...
        .row(titulo="3")
          .col-md-5.mb-4.mb-md-0
            ...
            ul.lista-ul--color.fa-ul.color-primario.ps-5
              li 
                i.fas.fa-plus
                | #[b Cintura: ] ¼ de contorno de cintura + pinza.
          .col-md-7
      ...
      .row.borde-redondo-tmorada(titulo="Paso 1")
        .col-md-4.mb-4.mb-md-0
          ...
          ul.lista-ul--color.fa-ul.color-primario.ps-5
              li 
                i.fas.fa-plus
                | #[b Largo: ] medida de talle posterior: 42,5 cm.
              li
                i.fas.fa-plus
                | #[b Ancho: ] ¼ de busto, 23 cm.
        .col-md-8
        ...
        .row(titulo="1")
          .col-md-5.mb-4.mb-md-0
            ...
            ul.lista-ul--color.fa-ul.color-primario.ps-1
              li 
                i.fas.fa-plus
                | #[b Largo del rectángulo= ] medida de talle delantero.
              li
                i.fas.fa-plus
                | #[b Ancho= ] ¼ de la medida de contorno de busto.
            p.ps-5.mt-5.mb-5 Sobre el rectángulo se ubican los puntos de:
            ul.lista-ul--color.fa-ul.color-primario.ps-1
              li 
                i.fas.fa-plus
                | #[b Centro frente (punto A). ]
              li
                i.fas.fa-plus
                | #[b ½ de la medida de talle (punto B).  Este punto se ubica utilizando la ventana de punto proporcional 0,5. ]
              li
                i.fas.fa-plus
        ...
        .row.justify-content-center.my-lg-4
          .col-md-4.mb-4.mb-md-0
            ...
            ul.lista-ul--color.fa-ul.color-primario.ps-1
              li 
                i.fas.fa-plus
                | #[b Cintura: ] ¼ contorno de cintura + pinza.
